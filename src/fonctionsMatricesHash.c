...
{   edge *edge0=node0->nodeEdge;
    ...
    while(currentNode->nextNode!=NULL){
        if(currentNode->nodeEdge!=NULL){
            currentNode->nodeEdge->otherNode->nodeNumber=currentNode->nodeEdge->edgeNumber;
        }
